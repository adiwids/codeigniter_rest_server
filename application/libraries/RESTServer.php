 ...
 * @version         3.0.0
 */
abstract class RESTServer extends \CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        // At present the library is bundled with REST4Server 2.5+, but will eventually be part of CodeIgniter (no citation)
